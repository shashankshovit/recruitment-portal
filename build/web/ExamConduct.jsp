    ...
    <body style="margin:0px" bgcolor="#FFFFFF">
        ...
        try {
            if (jid == null) {
                        ...
                        %>  <form name="examSelection" action ="ExamView.jsp">
                            <tr>
                                <td><span class="style7"><b>Post Name :</b></span></td>
                                <td><%=post%></td>
                                <td><input type="hidden" value="<%=post%>" name="post"></td>
                                <td width="11">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                <td class="style7"><div align="center">
                                        <input type="hidden" value="<%=jid%>" name="jobid">
                                        <input type="submit" value="OK ">
                                </div></td>
                            </tr>
                        </form>
